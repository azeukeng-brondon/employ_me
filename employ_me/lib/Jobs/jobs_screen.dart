...
import 'package:employ_me/Search/search_job.dart';
import 'package:employ_me/Widgets/bottom_nav_bar.dart';
import 'package:employ_me/Widgets/job_widget.dart';
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            icon: const Icon(Icons.filter_list_off_rounded, color: Colors.black,),
            onPressed: (){
